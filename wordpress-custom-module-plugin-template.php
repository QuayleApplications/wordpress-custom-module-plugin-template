...
define('PLUGIN_NAME', 'WordPress Custom Module Plugin Template');
...
function qcmptLoadScripts() {
    ...
    wp_enqueue_script( 'qcmpt-js', plugins_url( 'assets/js/app.js', __FILE__ ), array('jquery'), $js_ver, true );
    wp_enqueue_style( 'bootstrap-css', 'https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css', array(), '5.0.2', 'all' );
    wp_enqueue_style( 'qcmpt-style', plugins_url( 'assets/css/styles.css', __FILE__ ), array('bootstrap-css'), $css_ver, 'all' );
